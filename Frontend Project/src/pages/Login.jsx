...
const Login = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex flex-col items-center w-[50%] smmax-w-96 m-auto mt-14 gap-4 text-gray-800 ' action="">
      ...
      <button className='bg-black text-white font-light px-8 py-2 m-auto'>{currentState==='Login'?'Sign In':'Sign Up'}</button>
